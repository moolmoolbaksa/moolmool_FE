...
const kakaoLoginApi = createAsyncThunk(
    ...
    async (code, thunkAPI) => {
        try {
            const response = await axios.get(`https://langho968.shop/user/kakao?code=${code}`);
...
const setFirstUserInfoApi = createAsyncThunk(
    ...
    async (address) => {
        try {
            await axios.put(`https://langho968.shop/user/info`,{address},{
                headers: {
                    Authorization: localStorage.getItem('token'),
                }
            });
...
const getMyInfoApi = createAsyncThunk(
    ...
    async () => {
        try {
            const response = await axios.get(`https://langho968.shop/api/mypage`,{
                headers: {
                    Authorization: localStorage.getItem('token'),
                }
            });
...
const updateMyInfoApi = createAsyncThunk(
    ...
    async (formData, thunkAPI) => {
        try {
            const response = await axios.post(`https://langho968.shop/api/mypage`,formData,{
                headers: {
...
const getCounterUserInfoApi = createAsyncThunk(
    ...
    async (userId) => {
        console.log(userId)
        try {
            const response = await axios.get(`https://langho968.shop/api/store/${userId}`);
